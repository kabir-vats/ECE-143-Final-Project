...
if __name__ == "__main__":
    ...
    eval_LSTM_classifier(args.model_name, args.model_path, args.save_plots) if args.model_name == 'LSTM' else (eval_BERT_classifier(args.model_name, args.model_path, args.save_plots) if args.model_name == 'BERT' else eval_text_classifier(args.model_name, args.model_path, args.save_plots))